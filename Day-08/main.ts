import { calculateAreaOfRec, calculatePerimeterOfRec } from "./exportFunction";
import { Circle } from "./f2";
...
console.log(calculateAreaOfRec(5, 10)); //50
console.log(calculatePerimeterOfRec(5, 10)); //30
...
let areaOfCircle = new Circle("Circle", 2, 5);
console.log(`Name: ${areaOfCircle.name} Area: ${areaOfCircle.calculateArea()}`); //Name: Circle Area: 78.5
