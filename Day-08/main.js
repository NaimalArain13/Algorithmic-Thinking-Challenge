...
console.log((0, exportFunction_1.calculateAreaOfRec)(5, 10));
console.log((0, exportFunction_1.calculatePerimeterOfRec)(5, 10));
...
console.log(`Name: ${areaOfCircle.name} Area: ${areaOfCircle.calculateArea()}`);
