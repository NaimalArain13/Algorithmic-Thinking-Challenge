...
const exportFunction_1 = require("./exportFunction");
...
console.log((0, exportFunction_1.calculateAreaOfRec)(5, 10)); //50
console.log((0, exportFunction_1.calculatePerimeterOfRec)(5, 10)); //30
...
// - Ensure that the file paths are correctly specified when importing.
let areaOfCircle = new f2_1.Circle("Circle", 2, 5);
