...
function findOdd(arr: number[]) {
  ...
  function productOdds(number: number[]) {
    let oddNum: number[] = findOdd(number);
    let productOdd = 0;
  ...
  function generatedTableOfOdds(number:number[]){
...
function findEven(arr: number[]) {
  ...
  function generatedSquareOfEven(number:number[]){
