...
// myStack.push(4)  //add item at the end of the stack 
// console.log(myStack.peek()) //return item at the top of the stack (4)
// myStack.push(5)  // add another item at the end of the stack
// myStack.push(6)  //add another item at the end of the stack
// console.log(myStack)   //Stack { stack: [ 4, 5, 6 ] }
// console.log(myStack.pop())  //6
// console.log(myStack.pop())  //5
// console.log(myStack)  //Stack { stack: [ 4 ] }
